...
${HOME_TOPMENU}             xpath=//div[@id="block_top_menu"]
${HOME_PRODUCT}             xpath=//div[@id="center_column"]//img[@alt="Faded Short Sleeve T-shirts"]
${HOME_BTN_ADDCART}         xpath=//button[@class="exclusive"]
${HOME_BTN_CHECKOUT}        xpath=//div[@id="layer_cart"]//a[@title="Proceed to checkout"]
