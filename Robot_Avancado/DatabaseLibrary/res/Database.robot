...
...             Para outro banco de dados, pesquisar outra library do seu banco para o python
...
Conectar no Banco de Dados
    ## PostgreSQL
                          # Driver do banco             # nome do Database      # username usado para instalar              # Onde está localizado
