...
Teste de Argumentos Opcionais
    Passando argumentos opcionais como parâmetro      nome=Vittorio   ultimo_nome=Perotto
    Passando argumentos opcionais como parâmetro      nome=Vittorio   nome_do_meio=teste     ultimo_nome=Perotto
...
Criando lista e dicionário via parâmetro
    ...
    Teste Criando uma Lista         Vittorio   teste   Perotto
    Teste Criando os dois           Vittorio   teste   Perotto    shell=True    env=False
...
Passando argumentos opcionais como parâmetro
    ...
    ### Valores opcionais ficam por último
    [Arguments]     ${nome}   ${ultimo_nome}   ${nome_do_meio}=Opcional
