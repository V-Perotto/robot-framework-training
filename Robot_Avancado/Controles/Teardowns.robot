...
Essa aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
    ${STATUS}           Run Keyword And Return Status   Should Be True      "Vittorio" == "Vittorio"
    Log     ${STATUS}
    Pass Execution If   ${STATUS}       message=Vittorio é igual Vittorio, então passou!

Essa keyword vai passar sozinha!
    Should Be True      "Vittorio" == "Vittorio"

Essa keyword vai falhar sozinha!
    Should Be True      "Vittorio" == "May"
